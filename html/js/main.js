$(function() {
    ...
    $("header, main, footer").on("click", function() {
        ...
        $document.scrollTop() >= 400 ? $(".scroll-top").css("opacity", ".75") : $(".scroll-top").css("opacity", "0"), 
        ...
        e.preventDefault();
        var name = $('input[name="name"]').val(), email = $('input[name="email"]').val(), message = $('textarea[name="message"]').val();
        console.log(name, email, message), $(".email-thanks").text("thanks for the message!"), 
