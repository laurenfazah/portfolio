$(function() {
    ...
    $(window).scroll(function() {
        if ($(window).width() >= 800) {
            $(window).scrollTop() + $(window).height() === $(document).height() ? $(".scroll-to.top").addClass("bottom") : $(".scroll-to.top").removeClass("bottom");
            ...
            sections.each(function() {
                ...
                $(this).addClass("active"), nav.find('a[href="#' + $(this).attr("id") + '"]').parent("li").addClass("active"));
            });
        }
